...
public class ConfigurationDependencyRegistration {
  ...
  public void RegisterDependencies(IServiceCollection services) {
    ...
    services.ConfigureRecord<AlertmanagerConfiguration>(this._configuration.GetSection("Alertmanager"));
    ...
    services.ConfigureRecord<GlobalAlertingConfiguration>(this._configuration.GetSection("Alerting"));
    services.ConfigureRecord<KubernetesApiAccessConfiguration>(this._configuration.GetSection("KubernetesApiAccess"));
  }
}
